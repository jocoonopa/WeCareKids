...
Route::get('/analysis/r/i/channel/{als_rpt_ib_channel}/cxt/auth', 'Frontend\AlsRptIbCxtController@auth')->where('als_rpt_ib_channel', '[0-9]+');
...
Route::put('/analysis/r/i/cxt/{als_rpt_ib_cxt}/submit', 'Frontend\AlsRptIbCxtController@submit')->where('als_rpt_ib_cxt', '[0-9]+');
