...
<blockquote>
    <p>意即孩童对于环境刺激感觉讯息的接收程度与行为处理模式，感觉阈值即是孩童的神经系统对于刺激的界线，界线过高而行为消极的孩童易出现精神涣散、专注力不集中；界线过高而行为消极的孩童则是过度亢奋、静不下来；界线过低的孩子的神经系统一直处于备战状态，会出现排斥状况甚至出现攻击行为。</p>
</blockquote>
<br/>
        ...
        <table class="table table-bordered">
            <tbody>
                <tr>
                    ...
                    <td>1.低登陆量<br/>[阈值高-行为被动]</td>
                    <td>2.感觉需求<br/>[阈值高-行为主动]</td>
                    <td>3.感觉敏感<br/>[阈值低-行为被动]</td>
                    <td>4.感觉逃避<br/>[阈值低-行为主动]</td>
                </tr>
                <tr>
